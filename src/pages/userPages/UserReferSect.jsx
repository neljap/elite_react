    ...
    <div className="bg-dark text-light user-depo-top">
      ...
      <div className="container">
        <div className="d-flex justify-content-between align-items-center flex-wrap">
          ...
          <div
            className="col-md-3 p-3 border border-success rounded"
            style={{ backgroundColor: "#2A3042" }}
          >
            <h4 className="text-center">Total Referral</h4>
            <h1 className="text-center">{data?.tRefer}</h1>
          </div>
          <div
            className="col-md-3 p-3 border border-success rounded"
            style={{ backgroundColor: "#2A3042" }}
          >
            <h4 className="text-center">Active Referral</h4>
            <h1 className="text-center">{data?.tRefer}</h1>
          </div>
        </div>
      </div>
